		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "UI5CICDTest",
									"targetURL": "#comtestui5cicdtest-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comtestui5cicdtest-display": {
								"semanticObject": "comtestui5cicdtest",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.test.ui5cicdtest",
									"url": sap.ui.require.toUrl("com/test/ui5cicdtest")
								}
							}
						}
					}
